...
class TaskRequest extends FormRequest
{
    ...
    public function prepareForValidation()
    {
        ...
        if(array_key_exists('content', $input)){
            $input['content'] = htmlspecialchars($input['content'], ENT_QUOTES);
        }
        if(array_key_exists('person_in_charge', $input)){
            $input['person_in_charge'] = htmlspecialchars($input['person_in_charge'], ENT_QUOTES);
        }
